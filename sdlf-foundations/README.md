...
| ------------------------------------------------ | ----------------------------------------------------------------------------------------- | ------------------------------- |
| `octagon-ObjectMetadata-{environment}`           | Metadata for all objects in the data lake raw & stage buckets (populated by `sdlf-catalog`) | `/SDLF/{Domain}/Dynamo/ObjectCatalog`  |
| `octagon-Datasets-{environment}`                 | Metadata for all user-defined datasets (populated by `sdlf-dataset`)                      | `/SDLF/{Domain}/Dynamo/TransformMapping`, `/SDLF/Dynamo/Datasets` |
...
| `octagon-Teams-{environment}`                    | Metadata for all data teams and notification topics (populated by `sdlf-team`)            | `/SDLF/{Domain}/Dynamo/TeamMetadata`     |
| `octagon-Pipelines-{environment}`                | Metadata for all data pipeline stages (populated by `sdlf-team`)                          | `/SDLF/{Domain}/Dynamo/Pipelines`        |
...
| `octagon-DataSchemas-{environment}`              | Structure of all datasets (populated by `sdlf-replicate`, based on Glue catalog)          | `/SDLF/{Domain}/Dynamo/DataSchemas`      |
| `octagon-Manifests-{environment}`                | Track manifests and files for manifest-file-based processing                              | `/SDLF/{Domain}/Dynamo/Manifests`        |
...
| ------------------------------------------ | ---------------------------------------------------------------- | -------------------------------------------- |
| `/SDLF/{Domain}/Dynamo/ObjectCatalog`               | Name of the DynamoDB used to store metadata                      |                                              |
| `/SDLF/{Domain}/Dynamo/TransformMapping`            | Name of the DynamoDB used to store mappings to transformation    |                                              |
| `/SDLF/{Domain}/Dynamo/Pipelines`                   | Name of the DynamoDB used to store pipelines metadata            |                                              |
| `/SDLF/{Domain}/Dynamo/TeamMetadata`                | Name of the DynamoDB used to store teams metadata                |                                              |
| `/SDLF/{Domain}/Dynamo/DataSchemas`                 | Name of the DynamoDB used to store data schemas                  |                                              |
| `/SDLF/{Domain}/Dynamo/Manifests`                   | Name of the DynamoDB used to store manifest process metadata     |                                              |
| `/SDLF/{Domain}/IAM/LakeFormationDataAccessRole`    | Lake Formation Data Access Role name                             |                                              |
| `/SDLF/{Domain}/IAM/LakeFormationDataAccessRoleArn` | Lake Formation Data Access Role ARN                              |                                              |
| `/SDLF/{Domain}/IAM/DataLakeAdminRoleArn`           | Lake Formation Data Lake Admin Role ARN                          |                                              |
| `/SDLF/{Domain}/KMS/KeyArn`                         | ARN of the default KMS key used for encrypting data lake buckets |                                              |
| `/SDLF/{Domain}/Misc/pOrg`                          | Name of the Organization owning the datalake                     |                                              |
| `/SDLF/{Domain}/Misc/pDomain`                       | Data domain name                                                 |                                              |
| `/SDLF/{Domain}/Misc/pEnv`                          | Environment name                                                 |                                              |
| `/SDLF/{Domain}/S3/AccessLogsBucket`                | Access Logs S3 bucket name                                       |                                              |
| `/SDLF/{Domain}/S3/ArtifactsBucket`                 | Artifacts S3 bucket name                                         |                                              |
| *`/SDLF/{Domain}/S3/CentralBucket`*                 | *Central S3 bucket name*                                         | deprecated, use `/SDLF/S3/RawBucket` instead |
| `/SDLF/{Domain}/S3/RawBucket`                       | Raw S3 bucket name                                               |                                              |
| `/SDLF/{Domain}/S3/StageBucket`                     | Stage S3 bucket name                                             |                                              |
| `/SDLF/{Domain}/S3/AnalyticsBucket`                 | Analytics S3 bucket name                                         |                                              |
| `/SDLF/{Domain}/S3/AthenaBucket`                    | Athena query results S3 bucket name                              |                                              |
